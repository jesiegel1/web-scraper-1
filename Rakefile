...
namespace :package do
  ...
  task :osx => [:bundle_install,
    ...
    "packaging/traveling-ruby-gems-20150715-2.2.2-osx/nokogiri-1.6.5.tar.gz"
  ] do
    create_package("osx")
  end
...
file "packaging/traveling-ruby-gems-20150715-2.2.2-osx/nokogiri-1.6.5.tar.gz" do
...
def create_package(target)
  ...
  sh "cp scraper.rb #{package_dir}/lib/app/"
  sh "mkdir #{package_dir}/lib/ruby"
  sh "tar -xzf packaging/traveling-ruby-#{TRAVELING_RUBY_VERSION}-#{target}.tar.gz -C #{package_dir}/lib/ruby"
  sh "cp packaging/wrapper.sh #{package_dir}/scraper"
  sh "cp -pR packaging/vendor #{package_dir}/lib/"
  sh "cp Gemfile Gemfile.lock #{package_dir}/lib/vendor/"
  sh "mkdir #{package_dir}/lib/vendor/.bundle"
  sh "cp packaging/bundler-config #{package_dir}/lib/vendor/.bundle/config"
  sh "tar -xzf packaging/traveling-ruby-20150715-2.2.2-osx-nokogiri-1.6.5.tar.gz " +
